...
const claude_analyzer_1 = require("../analyzers/ai/claude-analyzer");
const VERSION = '1.0.0';
...
function buildStaticOnlyCategories(staticFindings) {
    const categories = ['security', 'quality', 'performance', 'architecture', 'dependencies', 'testing', 'documentation'];
...
async function runAudit(options, onProgress) {
    ...
    if (!options.noAi && apiKey) {
        ...
        try {
            categories = await (0, claude_analyzer_1.analyzeWithClaude)(files, info, apiKey, options.model);
