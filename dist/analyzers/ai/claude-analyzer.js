...
function buildAuditPrompt(info, codeContext) {
...
async function analyzeWithClaude(files, info, apiKey, model) {
    ...
    const categoryOrder = ['security', 'quality', 'performance', 'architecture', 'testing', 'documentation'];
